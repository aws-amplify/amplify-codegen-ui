 ...
 *                   - Returns sanitized value after filtering dangerous patterns
 *
 * @example
...
export function escapePropertyValue(propertyValue: string): string {
  ...
  // Then sanitize the name to ensure it's a valid JavaScript identifier
  return filterDangerousPatterns(propertyValue);
}
